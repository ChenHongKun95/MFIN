...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default="./config/uavid/mfin.py", help="Path to  config")
    arg("-o", "--output_path", type=Path, help="Path to save resulting masks.", default='./fig_results/uavid/mfin')
